import { c as createLucideIcon, s as commonjsGlobal, t as getDefaultExportFromCjs, r as reactExports, v as clsx, R as React, w as invariant, x as useAuth, j as jsxRuntimeExports, h as Building2, a as Button, L as Link, y as LoadingSpinner, B as Badge, A as AnimatePresence, m as motion, X } from "./index-C7HzK6Z0.js";
import { g as useDashboard, h as useEmployeeProperties, i as useAddProperty, j as useUpdateProperty, k as useDeleteProperty, l as useMarkPropertySold, m as usePublishProperty, n as useUnpublishProperty, o as useInquiries, p as useVisitRequests } from "./use-properties-BkgRPE2u.js";
...
const GlobeLock = createLucideIcon("globe-lock", __iconNode$4);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const TABS = ["Overview", "Properties", "Inquiries", "Visit Requests"];
function StatCard({
  icon: Icon,
  label,
  value,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      "data-ocid": ocid,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-start justify-between mb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-lg bg-accent/10 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: "w-5 h-5 text-accent" }) }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display font-bold text-2xl text-foreground", children: value }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-muted-foreground mt-0.5", children: label }),
        sub && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-accent mt-1", children: sub })
      ]
    }
  );
}
...
function PropertyFormModal({
  ...
  const [amenityInput, setAmenityInput] = reactExports.useState("");
  const set = (k2, v2) => setForm((f2) => ({ ...f2, [k2]: v2 }));
  const addAmenity = () => {
    const a2 = amenityInput.trim();
    if (a2 && !form.amenities.includes(a2)) {
      set("amenities", [...form.amenities, a2]);
      setAmenityInput("");
    }
  };
  const removeAmenity = (a2) => set(
    "amenities",
    form.amenities.filter((x2) => x2 !== a2)
  );
  const handleSubmit = (e3) => {
    e3.preventDefault();
    onSubmit(form);
  };
  const inputCls = "w-full bg-input/60 border border-border rounded-lg px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-accent/40";
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between p-6 border-b border-border/40", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-semibold text-xl text-foreground", children: (initial == null ? void 0 : initial.title) ? "Edit Property" : "Add New Property" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Button,
                  {
                    variant: "ghost",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "p-6 space-y-5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "pf-title", className: labelCls, children: "Property Title *" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "input",
                    {
                      id: "pf-title",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "pf-city", className: labelCls, children: "City *" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "input",
                      {
                        id: "pf-city",
                        ...
                        required: true,
                        value: form.city,
                        onChange: (e3) => set("city", e3.target.value),
                        placeholder: "Mumbai",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "pf-address", className: labelCls, children: "Full Address" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "input",
                      {
                        id: "pf-address",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "pf-price", className: labelCls, children: "Price (₹) *" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "input",
                      {
                        id: "pf-price",
                        ...
                        min: 0,
                        value: form.price || "",
                        onChange: (e3) => set("price", Number(e3.target.value)),
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "pf-size", className: labelCls, children: "Size (sq.ft) *" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "input",
                      {
                        id: "pf-size",
                        ...
                        min: 0,
                        value: form.sizeSqFt || "",
                        onChange: (e3) => set("sizeSqFt", Number(e3.target.value)),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "pf-type", className: labelCls, children: "Property Type *" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "select",
                      {
                        id: "pf-type",
                        className: inputCls,
                        value: form.type,
                        onChange: (e3) => set("type", e3.target.value),
                        "data-ocid": "select-type",
                        children: PROPERTY_TYPES.map((t2) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: t2, className: "bg-card capitalize", children: t2 }, t2))
                      }
                    )
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "pf-facing", className: labelCls, children: "Facing Direction *" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "select",
                      {
                        id: "pf-facing",
                        className: inputCls,
                        value: form.facing,
                        onChange: (e3) => set("facing", e3.target.value),
                        "data-ocid": "select-facing",
                        children: FACING_DIRS.map((d2) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: d2, className: "bg-card capitalize", children: d2 }, d2))
                      }
                    )
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "pf-beds", className: labelCls, children: "Bedrooms" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "input",
                      {
                        id: "pf-beds",
                        ...
                        onChange: (e3) => set(
                          "bedrooms",
                          e3.target.value ? Number(e3.target.value) : void 0
                        ),
                        placeholder: "e.g. 3",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "pf-baths", className: labelCls, children: "Bathrooms" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "input",
                      {
                        id: "pf-baths",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "pf-desc", className: labelCls, children: "Description *" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "textarea",
                    {
                      id: "pf-desc",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "pf-amenity", className: labelCls, children: "Amenities" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 mb-2", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "input",
                      {
                        ...
                        value: amenityInput,
                        onChange: (e3) => setAmenityInput(e3.target.value),
                        onKeyDown: (e3) => {
                          if (e3.key === "Enter") {
                            e3.preventDefault();
                            addAmenity();
                  ...
                  form.amenities.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1.5", children: form.amenities.map((a2) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "span",
                    {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-sm text-foreground flex items-center gap-1.5", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { className: "w-3.5 h-3.5 text-accent" }),
                    "Mark as Featured"
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 pt-2", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Button,
                    {
                      ...
                      children: isLoading ? "Saving…" : (initial == null ? void 0 : initial.title) ? "Update Property" : "Add Property"
                    }
                  )
                ] })
              ] })
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-lg text-foreground mb-2", children: "Delete Property" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-4", children: [
      {
        ...
        value: totalProperties || (stats == null ? void 0 : stats.totalListings) || 0,
        ocid: "stat-total"
      },
      {
        icon: CircleCheckBig,
        label: "Active Listings",
        value: (stats == null ? void 0 : stats.activeListings) ?? 0,
        ocid: "stat-active"
      },
      {
        icon: TrendingUp,
        label: "Sold Properties",
        value: (stats == null ? void 0 : stats.soldListings) ?? 0,
        ocid: "stat-sold"
      },
      {
        icon: MessageSquare,
        label: "Total Inquiries",
        value: (stats == null ? void 0 : stats.totalInquiries) ?? 0,
        ocid: "stat-inquiries"
      }
    ].map((s2, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
        initial: { opacity: 0, y: 16 },
        animate: { opacity: 1, y: 0 },
        transition: { duration: 0.4, delay: i * 0.08 },
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { ...s2 })
      },
      s2.ocid
    )) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-xl bg-accent/10 flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Calendar, { className: "w-6 h-6 text-accent" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display font-bold text-xl text-foreground", children: (stats == null ? void 0 : stats.totalVisitRequests) ?? 0 }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-muted-foreground", children: "Visit Requests Pending" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "ml-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "bg-accent/10 text-accent border-none", children: "Review Required" }) })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "font-semibold text-foreground mb-5 flex items-center gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Eye, { className: "w-4 h-4 text-accent" }),
                  "Monthly Activity"
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 220, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  BarChart,
                  {
                    data: (stats == null ? void 0 : stats.monthlyInquiries) ?? [],
                    barSize: 18,
                    barGap: 4,
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 160, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(PieChart, { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Pie,
                    {
                      data: (stats == null ? void 0 : stats.propertyTypeBreakdown) ?? [],
                      cx: "50%",
                      cy: "50%",
                      innerRadius: 42,
                      outerRadius: 68,
                      paddingAngle: 3,
                      dataKey: "count",
                      children: ((stats == null ? void 0 : stats.propertyTypeBreakdown) ?? []).map((entry, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                        Cell,
                        {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Tooltip,
                    {
                      ...
                      formatter: (v2, _n, p2) => [`${v2} properties`, p2.payload.type]
                    }
                  )
                ] }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2 mt-2", children: ((stats == null ? void 0 : stats.propertyTypeBreakdown) ?? []).map((entry, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "capitalize", children: entry.type })
                    ]
                  },
                  entry.type
                )) })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 180, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(LineChart, { data: (stats == null ? void 0 : stats.monthlyInquiries) ?? [], children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              CartesianGrid,
              {
                strokeDasharray: "3 3",
...
function PropertiesTab({ properties }) {
  ...
  const [editProp, setEditProp] = reactExports.useState(null);
  const [deleteProp, setDeleteProp] = reactExports.useState(null);
  const [publishedIds, setPublishedIds] = reactExports.useState(
    () => new Set(
      properties.filter((p2) => p2.status === "available").map((p2) => p2.id)
    )
  );
  ...
  const handleMarkSold = (id) => markSold.mutate(id);
  const handleTogglePublish = (p2) => {
    const isPublished = publishedIds.has(p2.id);
    if (isPublished) {
      unpublishProperty.mutate(p2.id, {
        onSuccess: () => setPublishedIds((prev) => {
      ...
      publishProperty.mutate(p2.id, {
        onSuccess: () => setPublishedIds((prev) => /* @__PURE__ */ new Set([...prev, p2.id]))
      });
    }
  };
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "bg-muted/30 border-b border-border/40", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-4 py-3 text-xs font-medium text-muted-foreground uppercase tracking-wide", children: "Property" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-4 py-3 text-xs font-medium text-muted-foreground uppercase tracking-wide hidden md:table-cell", children: "City" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-4 py-3 text-xs font-medium text-muted-foreground uppercase tracking-wide hidden sm:table-cell", children: "Price" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-4 py-3 text-xs font-medium text-muted-foreground uppercase tracking-wide hidden lg:table-cell", children: "Type" }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-4 py-3 text-xs font-medium text-muted-foreground uppercase tracking-wide", children: "Published" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-right px-4 py-3 text-xs font-medium text-muted-foreground uppercase tracking-wide", children: "Actions" })
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-border/30", children: properties.map((p2, i) => {
              const isPublished = publishedIds.has(p2.id);
              return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                motion.tr,
                {
                  ...
                  "data-ocid": `row-property-${p2.id}`,
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-lg overflow-hidden shrink-0 bg-muted", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "img",
                        {
                          src: p2.images[0] ?? "/assets/images/placeholder.svg",
                          alt: p2.title,
                          className: "w-full h-full object-cover",
                          onError: (e3) => {
                            e3.currentTarget.src = "/assets/images/placeholder.svg";
                          }
                        }
                      ) }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium text-foreground truncate max-w-[140px]", children: p2.title })
                    ] }) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-muted-foreground hidden md:table-cell", children: p2.city }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 font-semibold text-accent hidden sm:table-cell", children: p2.priceLabel }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 hidden lg:table-cell", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "capitalize text-muted-foreground", children: p2.type }) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                      Badge,
                      {
                        className: `text-xs capitalize ${p2.status === "available" ? "bg-emerald-50 text-emerald-700 dark:bg-emerald-950/30 dark:text-emerald-400 border-0" : p2.status === "sold" ? "bg-red-50 text-red-600 dark:bg-red-950/30 dark:text-red-400 border-0" : "bg-amber-50 text-amber-700 dark:bg-amber-950/30 dark:text-amber-400 border-0"}`,
                        children: p2.status
                      }
                    ) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                      motion.div,
                      {
                        ...
                        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                          Badge,
                          {
                            className: `text-xs flex items-center gap-1 w-fit border-0 ${isPublished ? "bg-emerald-50 text-emerald-700 dark:bg-emerald-950/30 dark:text-emerald-400" : "bg-muted/60 text-muted-foreground"}`,
                            "data-ocid": `badge-published-${p2.id}`,
                            children: [
                              isPublished ? /* @__PURE__ */ jsxRuntimeExports.jsx(Globe, { className: "w-3 h-3" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(GlobeLock, { className: "w-3 h-3" }),
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 justify-end", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        Button,
                        {
                          variant: "ghost",
                          size: "sm",
                          className: `text-xs h-7 px-2 ${isPublished ? "text-muted-foreground hover:text-foreground" : "text-emerald-600 hover:text-emerald-700 hover:bg-emerald-50"}`,
                          onClick: () => handleTogglePublish(p2),
                          "data-ocid": `btn-toggle-publish-${p2.id}`,
                          children: isPublished ? "Unpublish" : "Publish"
                        }
                      ),
                      p2.status !== "sold" && /* @__PURE__ */ jsxRuntimeExports.jsx(
                        Button,
                        {
                          variant: "ghost",
                          size: "sm",
                          className: "text-xs h-7 px-2 text-muted-foreground hover:text-foreground",
                          onClick: () => handleMarkSold(p2.id),
                          "data-ocid": `btn-mark-sold-${p2.id}`,
                          children: "Sold"
                        }
                      ),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        Button,
                        {
                          ...
                          onClick: () => setEditProp(p2),
                          "aria-label": "Edit property",
                          "data-ocid": `btn-edit-${p2.id}`,
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        Button,
                        {
                          ...
                          onClick: () => setDeleteProp(p2),
                          "aria-label": "Delete property",
                          "data-ocid": `btn-delete-${p2.id}`,
          ...
          properties.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm", children: "No properties yet. Add your first listing." })
              ]
            }
          )
        ]
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(AnimatePresence, { children: [
      ...
      editProp && /* @__PURE__ */ jsxRuntimeExports.jsx(
        PropertyFormModal,
        {
          initial: {
      ...
      deleteProp && /* @__PURE__ */ jsxRuntimeExports.jsx(
        DeleteDialog,
        {
...
function InquiriesTab() {
  ...
  if (isLoading) return /* @__PURE__ */ jsxRuntimeExports.jsx(LoadingSpinner, { size: "md", text: "Loading inquiries…" });
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-5", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { className: "bg-accent/10 text-accent border-none", children: [
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "bg-muted/30 border-b border-border/40", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-4 py-3 text-xs font-medium text-muted-foreground uppercase tracking-wide hidden sm:table-cell", children: "Phone" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-4 py-3 text-xs font-medium text-muted-foreground uppercase tracking-wide hidden md:table-cell", children: "Email" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-4 py-3 text-xs font-medium text-muted-foreground uppercase tracking-wide hidden lg:table-cell", children: "Message" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-4 py-3 text-xs font-medium text-muted-foreground uppercase tracking-wide hidden md:table-cell", children: "Date" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-right px-4 py-3 text-xs font-medium text-muted-foreground uppercase tracking-wide", children: "Status" })
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-border/30", children: inquiries.map((inq, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              motion.tr,
              {
                initial: { opacity: 0, x: -8 },
                animate: { opacity: 1, x: 0 },
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 font-medium text-foreground max-w-[130px] truncate", children: inq.propertyTitle }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-foreground", children: inq.name }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-muted-foreground hidden sm:table-cell", children: inq.phone }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-muted-foreground hidden md:table-cell", children: inq.email }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-muted-foreground max-w-[200px] truncate hidden lg:table-cell", children: inq.message }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-muted-foreground text-xs hidden md:table-cell", children: new Date(Number(inq.createdAt)).toLocaleDateString(
                    "en-IN",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-right", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Badge,
                    {
                      ...
                      children: inq.isRead ? "Read" : "Unread"
                    }
                  ) })
                ]
              },
          ...
          inquiries.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: "flex flex-col items-center justify-center py-16 text-center",
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm", children: "No inquiries received yet." })
              ]
            }
          )
        ]
...
function VisitRequestsTab() {
  ...
  if (isLoading)
    return /* @__PURE__ */ jsxRuntimeExports.jsx(LoadingSpinner, { size: "md", text: "Loading visit requests…" });
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "font-semibold text-foreground", children: [
        "Visit Requests (",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { className: "bg-accent/10 text-accent border-none", children: [
        visits.filter((v2) => v2.status === "pending").length,
        " pending"
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "bg-muted/30 border-b border-border/40", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-4 py-3 text-xs font-medium text-muted-foreground uppercase tracking-wide", children: "Name" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-4 py-3 text-xs font-medium text-muted-foreground uppercase tracking-wide hidden sm:table-cell", children: "Phone" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-4 py-3 text-xs font-medium text-muted-foreground uppercase tracking-wide hidden md:table-cell", children: "Preferred Date" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-4 py-3 text-xs font-medium text-muted-foreground uppercase tracking-wide hidden md:table-cell", children: "Time" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-right px-4 py-3 text-xs font-medium text-muted-foreground uppercase tracking-wide", children: "Status" })
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-border/30", children: visits.map((visit, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              motion.tr,
              {
                initial: { opacity: 0, x: -8 },
                animate: { opacity: 1, x: 0 },
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 font-medium text-foreground max-w-[130px] truncate", children: visit.propertyTitle }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-foreground", children: visit.customerName }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-muted-foreground hidden sm:table-cell", children: visit.customerPhone }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-muted-foreground hidden md:table-cell", children: visit.preferredDate }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-muted-foreground hidden md:table-cell", children: visit.preferredTime }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-right", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Badge,
                    {
                      className: `text-xs capitalize ${visit.status === "pending" ? "bg-amber-50 text-amber-700 dark:bg-amber-950/30 dark:text-amber-400 border-0" : visit.status === "confirmed" ? "bg-emerald-50 text-emerald-700 dark:bg-emerald-950/30 dark:text-emerald-400 border-0" : visit.status === "cancelled" ? "bg-red-50 text-red-600 dark:bg-red-950/30 dark:text-red-400 border-0" : "bg-muted/60 text-muted-foreground border-0"}`,
          ...
          visits.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: "flex flex-col items-center justify-center py-16 text-center",
              "data-ocid": "empty-visits",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Calendar, { className: "w-10 h-10 text-muted-foreground/30 mb-3" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm", children: "No visit requests yet." })
              ]
            }
          )
        ]
...
function DashboardPage() {
  ...
  const { data: properties = [], isLoading: propsLoading } = useEmployeeProperties();
  ...
  if (!isLoggedIn) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center min-h-[60vh] text-center px-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 rounded-2xl bg-accent/10 flex items-center justify-center mb-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Building2, { className: "w-8 h-8 text-accent" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-heading mb-3", children: "Employee Dashboard" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm mb-6 max-w-xs", children: "Please log in with Internet Identity to access the employee dashboard." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button,
        {
          onClick: login,
          ...
          children: "Log in with Internet Identity"
        }
      )
    ] });
  }
  if (!isEmployee) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center min-h-[60vh] text-center px-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 rounded-2xl bg-destructive/10 flex items-center justify-center mb-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Building2, { className: "w-8 h-8 text-destructive" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-heading mb-3", children: "Access Restricted" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm mb-6", children: "This dashboard is for employees only." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/properties", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", "data-ocid": "btn-goto-properties", children: "Browse Properties" }) })
    ] });
  }
  if (statsLoading || propsLoading)
    return /* @__PURE__ */ jsxRuntimeExports.jsx(LoadingSpinner, { size: "lg", text: "Loading dashboard…", fullPage: true });
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background", "data-ocid": "page-dashboard", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border-b border-border/50 sticky top-0 z-20", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 py-4 flex items-center justify-between gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display font-semibold text-xl text-foreground", children: "Employee Dashboard" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "bg-accent/10 text-accent border-none text-xs hidden sm:inline-flex", children: "Employee" }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "nav",
        {
          ...
          children: TABS.map((tab) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              className: `shrink-0 px-4 py-2.5 text-sm font-medium border-b-2 transition-smooth whitespace-nowrap ${activeTab === tab ? "border-accent text-accent" : "border-transparent text-muted-foreground hover:text-foreground"}`,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4 py-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        transition: { duration: 0.25 },
        children: [
          activeTab === "Overview" && /* @__PURE__ */ jsxRuntimeExports.jsx(OverviewTab, { stats, totalProperties: properties.length }),
          activeTab === "Properties" && /* @__PURE__ */ jsxRuntimeExports.jsx(PropertiesTab, { properties }),
          activeTab === "Inquiries" && /* @__PURE__ */ jsxRuntimeExports.jsx(InquiriesTab, {}),
          activeTab === "Visit Requests" && /* @__PURE__ */ jsxRuntimeExports.jsx(VisitRequestsTab, {})
        ]
      },
      activeTab
    ) }) })
